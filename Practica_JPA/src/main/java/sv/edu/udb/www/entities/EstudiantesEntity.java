...
@NamedQueries({
        ...
        @NamedQuery(name = "EstudianteEntity.findByCarnet", query = "SELECT e FROM EstudiantesEntity e WHERE e.carnet = :carnet"),
        @NamedQuery(name = "EstudianteEntity.findByNombres", query = "SELECT e FROM EstudiantesEntity e WHERE e.nombres = :nombres" ),
        @NamedQuery(name = "EstudianteEntity.findByApellidos", query = "SELECT e FROM EstudiantesEntity e WHERE e.apellidos = :apellidos"),
        @NamedQuery(name = "EstudianteEntity.findByEdad", query = "SELECT e FROM EstudiantesEntity e WHERE e.edad = :edad"),
        @NamedQuery(name = "EstudianteEntity.findByCum", query = "SELECT e FROM EstudiantesEntity e WHERE e.cum = :cum"),
        @NamedQuery(name = "EstudianteEntity.findByGenero", query = "SELECT e FROM EstudiantesEntity e WHERE e.genero = :genero"),
        @NamedQuery(name = "EstudianteEntity.findByCarrera", query = "SELECT e FROM EstudiantesEntity e WHERE e.carrera = :carrera"),
